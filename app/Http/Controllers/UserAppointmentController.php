...
class UserAppointmentController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::all();
        return view('admin.user_appointment.index', compact('user_appointment','users'))->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    {
        $users = User::all();
        return view('admin.user_appointment.create', compact('users'));
    }
    ...
    {
        return view('admin.user_appointment.show', compact('userAddress'));
    }
    ...
    public function edit(UserAppointment $userAddress)
    {
        $users = User::all();
        $cities = User::all();
        return view('admin.user_appointment.edit', compact('userAddress','users','cities'));
    }
