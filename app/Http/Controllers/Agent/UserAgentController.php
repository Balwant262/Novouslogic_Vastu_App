...
class UserAgentController extends Controller
{
    ...
    {
        $users = User::all();
        return view('agent.users.index', compact('users'))->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    {
        $users = User::all();
        return view('agent.users.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        User::create([
            ...
            'no_of_report_generate' => $request->no_of_report_generate,
    ...
    {
        return view('agent.users.show', compact('users'));
    }
