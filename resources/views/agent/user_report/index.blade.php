...
<div class="modal fade" role="dialog" id="modalAddnewuser_report">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="payment_request_form" action="{{ route('agent_user_report.store') }}" method="POST">
          @csrf
...
<div class="modal fade" role="dialog" id="modaledituser_report">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="payment_request_form" action="{{ route('agent_user_report.update', '1') }}" method="POST">
          @csrf
          @method('PUT')
        <input type="hidden" name="redirect_u" value="<?php echo $_SERVER['REQUEST_URI'] ?>">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        @foreach ($user_report as $zon)
            <tr>
                ...
                <td>
                    <form action="{{ route('agent_user_report.destroy', $zon->id) }}" method="POST">   
